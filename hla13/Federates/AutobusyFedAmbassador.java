...
public class AutobusyFedAmbassador extends NullFederateAmbassador {
    //----------------------------------------------------------
    //                    STATIC VARIABLES
    //----------------------------------------------------------
    ...
    public ArrayList<WejscieDoAutobusuEvent> wejscieDoAutobusuEvents = new ArrayList<WejscieDoAutobusuEvent>();

    //----------------------------------------------------------
    //                      CONSTRUCTORS
    //----------------------------------------------------------

    public AutobusyFedAmbassador()
    {
    }
    ...
    public void receiveInteraction( int interactionClass,
        ...
        try {
            ...
            if (Objects.equals(className, "InteractionRoot.WejscieDoAutobusu")) {
                try {
                    wejscieDoAutobusuEvents.add(
                            new WejscieDoAutobusuEvent(
