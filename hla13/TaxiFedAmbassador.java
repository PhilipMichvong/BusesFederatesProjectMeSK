...
public class TaxiFedAmbassador extends NullFederateAmbassador {
    //----------------------------------------------------------
    //                    STATIC VARIABLES
    //----------------------------------------------------------
    ...
    public ArrayList<String> pasazerowieId = new ArrayList<String>();

    //----------------------------------------------------------
    //                      CONSTRUCTORS
    //----------------------------------------------------------

    public TaxiFedAmbassador()
    {
    }
    ...
    public void receiveInteraction( int interactionClass,
        ...
        try {
            ...
            if (Objects.equals(className, "InteractionRoot.SzukanieTaxi")) {
                try {
//                    pasazerowieId = new ArrayList<>(
//                            Arrays.asList(
...
//                            )
//                    );
                    pasazerowieId.addAll(Arrays.asList(
                            EncodingHelpers.decodeString(
                                    theInteraction.getValue(0)
                            ).split(",")
                    ));
                ...
                System.out.println("Przyszli: ");
                for(String pasazerId : pasazerowieId){
                    System.out.print(pasazerId);
                }
            }
            if(Objects.equals(className, "InteractionRoot.Koniec")){
                System.out.println("otrzymalem koniec");
                running = false;
            }
            System.out.println();
